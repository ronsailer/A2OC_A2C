...
exp_config_str = "_".join([args.env_name, args.algo])
if args.algo == 'a2oc':
	exp_config_str = "_".join([args.num_options, args.delib])

log_dir = os.path.join(args.log_dir_base_path, exp_config_str)
